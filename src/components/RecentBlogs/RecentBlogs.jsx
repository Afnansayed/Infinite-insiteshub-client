...
const RecentBlogs = () => {
  ...
  //  console.log(blogs)
    return (
        <section className="py-6 sm:py-12 dark:bg-sky-100 dark:text-gray-800">
            <div className="container p-6 mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 lg:hover:gap-12 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
